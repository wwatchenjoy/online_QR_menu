...
2. Изменение заказа
3. Отмена заказа
4. Уведомление о желании оплатить счет
5. Оставить чаевые<br/>
...
Все изменения в меню проводятся Официантом и/или Ответственным менеджером через стандартый терминал(R-Keeper или iiko) в заведении. Весь функционал заведения должен быть синхронизирован внутри Системы и изменять состав меню на стороне Гостя одновременно с изменениями в терминале.<br/>
...
### 2.4.3 Отмена заказа
У Гостя есть возможность отмены заказа до определенного времени синхронно с удалением тикета в терминале.<br/>
...
Основной функционал Оформления, Изменения заказа и Чаевых остается аналогичным одному Гостю.
...
Именно поэтому на этапе Оплаты(нажатия кнопки "Оплатить" в интерфейсе Гостя в Системе) пользователю должен предоставляться выбор способа оплаты.
Тут необходимо следовать нескольким условиям:<br/>
1. Первоначально у всех Гостей в сессии установлен способ "Оплатить за себя"
2. При нажатии Гостем кнопки "Оплатить"(установлен способ "Оплатить за себя"), Гость обслуживается Официантом как один и автоматически отключается от сессии остальных Гостей. Отключение конкретного Гостя от сессии должно быть синхронизированно внутри Системы с остальными Гостями.
...
Таким образом необходимо продумать все возможные варианты Аналитики этих данных, которые будут непосредственно удобны для просмотра Владельцем заведения.<br/>
...
Логотип, название проекта и название команды надо придумать в ближайшее время в рамках этого проекта.
Должен присутствовать логотип Системы где-то на странице. Возможна его кликабельность с ссылкой на сайт или GitHub проекта. 

# 5. Законы и предметная область
Необходимо составить список всех законов, связанных ресторанным бизнесом и обслуживанием Гостей.<br/>
Также в ближайшее время нужно проконсультироваться с реальными владельцами подобных бизнесов для корректировки бизнес-требований.
