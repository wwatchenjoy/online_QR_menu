...
Для реализации функционала уведомления Официанта о пожверждении Гостем заказа необходимо создать один Telegram-бот на заведение, в который автоматически приходят уведомления в формате:<br/>
...
3. В случае выбора "Оплатить за всех", автоматически формируется общий чек на всю сессию.<br/>
